...
root            (hd0,#PARTNUM#)
kernel          /boot/linux-backharddi-ng backharddi/medio=hd-media video=vesa:ywrap,mtrr vga=788 locale=es_ES console-keymaps-at/keymap=es quiet --
initrd          /boot/minirt-backharddi-ng.gz
boot

title           Backharddi NG NET
root            (hd0,#PARTNUM#)
kernel          /boot/linux-backharddi-ng backharddi/medio=net video=vesa:ywrap,mtrr vga=788 netcfg/choose_interface=auto netcfg/get_hostname=bkd netcfg/get_domain= locale=es_ES console-keymaps-at/keymap=es quiet --
initrd          /boot/minirt-backharddi-ng.gz
boot
